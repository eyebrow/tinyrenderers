...
#if defined(TINY_RENDERER_VK)
	// Uses HLSL source
	auto vert = load_file(kAssetDir + "Sv01.vs.spv");
	auto frag = load_file(kAssetDir + "Sv01.ps.spv");
	tr_create_shader_program(m_renderer,
		vert.size(), (uint32_t*)(vert.data()), "main",
		frag.size(), (uint32_t*)(frag.data()), "main", &m_shader);
#elif defined(TINY_RENDERER_DX)
    auto vs_hlsl = load_file(kAssetDir + "Sv01.vs.hlsl");
    auto ps_hlsl = load_file(kAssetDir + "Sv01.ps.hlsl");
    tr_create_shader_program(m_renderer, 
